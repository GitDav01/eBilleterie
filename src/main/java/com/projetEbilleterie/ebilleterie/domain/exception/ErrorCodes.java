...
public final class ErrorCodes {
    ...
    public static final String BASKET_NOT_FOUND =  " ERR_0012 ";
    ...
    public static final String ETICKET_NOT_FOUND =  " ERR_0022 ";
    ...
    public static final String CUSTOMER_NOT_FOUND = " ERR_0032 ";

    public static final String RELATIVE_NOT_FOUND =  " ERR_0042 ";
