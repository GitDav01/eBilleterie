package com.projetEbilleterie.ebilleterie.exposition.exception;
...
@ControllerAdvice(basePackages = "com.projetEbilleterie.ebilleterie")
public class MyExceptionHandler {
    ...
    @ExceptionHandler(value = MyAppTicketException.class)
    public Set<String> handleBusinessException(MyAppTicketException exceptions) {
