...
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,false,'06122020','INTERNAL_UNIQUE_PRICE',51.50,200,'https://imageUGC');
...
,'tarif UGC 10 Cartes UGC Solo (1 lot par trimestre civil) PRIX INTERNE 51,50 € • CLIENT 68 €'
,false,'06122020','EXTERNAL_UNIQUE_PRICE',68,100,'https://imageUGC');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,false,'06122020','INTERNAL_UNIQUE_PRICE',54,300,'https://cineCHEQUE');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,'tarif CinéChèque 10 contremarques CinéChèque (1 lot par trimestre civil) PRIX INTERNE 54 € • CLIENT 71,50 € '
,false,'06122020','EXTERNAL_UNIQUE_PRICE',71.50,600,'https://cineCHEQUE');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,false,'06122020','INTERNAL_UNIQUE_PRICE',64,300,'https://Gaumont Pathe');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,'tarif Ciné Accès 10 Cartes Ciné Accès (1 lot par trimestre civil) PRIX INTERNE 64 € • CLIENT 85 € '
,false,'06122020','INTERNAL_UNIQUE_PRICE',85,200,'https://Gaumont Pathe');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,false,'06122020','INTERNAL_UNIQUE_PRICE',15,100,'https://Jardin accimatation');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,'Tarif unique - de 3 ans : entrée est gratuite (mais pas les manèges),INTERNE 15 € • CLIENT 21 € • '
,false,'06122020','EXTERNAL_UNIQUE_PRICE',21,200,'https://Jardin accimatation');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,false,'06122020','INTERNAL_CHILD_PRICE',12,100,'https://Jardin Zoo de beauval');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,'TTarif enfant (3 à 10 ans inclus) CSEEPF 12 € • extérieur 18 € • public 23 € Tarif adulte (11 ans et plus) INTERNE 17 € • CLIENT 23 € • public 29  '
,false,'06122020','EXTERNAL_CHILD_PRICE',18,100,'https://Jardin Zoo de beauval');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,'TTarif enfant (3 à 10 ans inclus) CSEEPF 12 € • extérieur 18 € • public 23 € Tarif adulte (11 ans et plus) INTERNE 17 € • CLIENT 23 € • public 29  '
,false,'06122020','INTERNAL_CHILD_PRICE',17,100,'https://Jardin Zoo de beauval');
INSERT INTO ETICKET (id, category,reference, description,law,nominative,VALIDITY_DATE,type_Price,price,stock,logo)
...
,'TTarif enfant (3 à 10 ans inclus) CSEEPF 12 € • extérieur 18 € • public 23 € Tarif adulte (11 ans et plus) INTERNE 17 € • CLIENT 23 € • public 29  '
,false,'06122020','EXTERNAL_CHILD_PRICE',23,400,'https://Jardin Zoo de beauval');
